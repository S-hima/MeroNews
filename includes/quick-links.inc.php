...
<div class="col-md-3">
  <div class="list-group">
    ...
    <a href="chart_index.php" class="list-group-item"><span class="glyphicon glyphicon-sd-video"></span> View Charts & Graphs
    </a>
    <a href="summary.php" class="list-group-item"><span class="glyphicon glyphicon-sd-video"></span> View Summary Graph
    </a>
