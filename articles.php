...
function deleteConfirm(id) {
  if (confirm("Are you sure you want to delete this article ?")) {
    ...
    var deactiveTrending = "./deactivate-trend.php?id=" +id;
    document.location = url;
    document.location = deactiveTrending;
  }
}

function removeTrend(idNew)
{
  let doThis = "./deactivate-trend.php?id=" + idNew;
  alert(doThis);
  document.location=doThis;
}
                  ...
                  while($data = mysqli_fetch_assoc($result)) {
                    ...
                    echo '
                      <tr>
                        ...
                        echo "<p>Activate Article & Make Trending..</p>";
                        "./deactivate-trend.php?id='.$article_id.'";
                        ...
                        if($article_active > 0) {
                          ...
                          <a class="btn btn-success" href="./deactivate-article.php?id='.$article_id.' " title="Deactivate Article" onclick=removeTrend('.$article_id.'); >
